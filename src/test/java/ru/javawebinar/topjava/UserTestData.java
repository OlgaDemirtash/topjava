...
public class UserTestData {
    ...
    public static final User adminWithMeals = new User(ADMIN_ID, "Admin", "admin@gmail.com", "admin", Role.ADMIN, Role.USER);

    public static User getUserWithMeals(User user, List<Meal> meals) {
        for (Meal meal : meals) {
            meal.setUser(user);
        }
        user.setMeals(meals);
